...
using Windows.Devices.Sensors;      // Inserir
using Windows.UI.Popups;            // Inserir
using Windows.UI.Core;              // Inserir
...
namespace Acelerometro_01
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            {
                MessageDialog ms = new MessageDialog("Acelerometro Não Encontrado");
                ms.ShowAsync();
            }
