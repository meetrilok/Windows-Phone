...
void ::SDKSample::Tiles::UsePushNotifications::InitializeComponent()
{
    if (_contentLoaded)
        return;
    ...
    // Call LoadComponent on ms-appx:///Scenario5_UsePushNotifications.xaml
    ::Windows::UI::Xaml::Application::LoadComponent(this, ref new ::Windows::Foundation::Uri(L"ms-appx:///Scenario5_UsePushNotifications.xaml"), ::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation::Application);
...
void ::SDKSample::Tiles::UsePushNotifications::Connect(int connectionId, Platform::Object^ target)
{
